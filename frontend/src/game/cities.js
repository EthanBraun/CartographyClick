...
//   Paris, Rome and Sydney as hard and Akola, Andernach and Ilorin as easy. So
//   rounds are banded by English Wikipedia readership over 60 days instead,
//   which is a decent proxy for "would a player place this".
//
...
// country the source happened to over-collect. That also keeps the deep tail
// out: round 5 is Bissau and Bujumbura, not somewhere nobody could place.
//
...
const TIERS = [
  // round 1 -- 123 places, 102k-677k monthly readers
  [
  ...
  // round 2 -- 123 places, 59k-101k monthly readers
  [
  ...
  // round 3 -- 123 places, 31k-59k monthly readers
  [
  ...
  // round 4 -- 123 places, 15k-31k monthly readers
  [
    ...
    {name: "N'Djamena", region: 'Chad', lat: 12.1348, lon: 15.0557},
  ...
  // round 5 -- 126 places, 1k-15k monthly readers
  [
    ...
    {name: 'Charlotte Amalie', region: 'St Thomas, US Virgin Islands', lat: 18.3419, lon: -64.9307},
    ...
    {name: 'Hagåtña', region: 'Guam', lat: 13.4757, lon: 144.7489},
    ...
    {name: "St. George's", region: 'Grenada', lat: 12.0564, lon: -61.7485},
    ...
    {name: 'Cockburn Town', region: 'Grand Turk Island, Turks & Caicos', lat: 21.4675, lon: -71.1389},
    ...
    {name: 'Basse-Terre', region: 'Guadeloupe', lat: 16.01, lon: -61.705},
    ...
    {name: 'Hamilton', region: 'Bermuda', lat: 32.2942, lon: -64.7839},
