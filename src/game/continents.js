...
const CONTINENTS = {
  Africa: [
    ...
    'Equatorial Guinea', 'Eritrea', 'Republic of the Congo',
  ...
  'North America': [
    'Anguilla', 'Antigua and Barbuda', 'Aruba', 'Bajo Nuevo Bank',
  ...
  Oceania: [
    ...
    'Federated States of Micronesia', 'Nauru', 'New Caledonia', 'New Zealand', 'Niue',
